...
.hero {
  ...
  @apply overflow-hidden py-20 sm:py-20 lg:pb-32 xl:pb-36;
  ...
  &__layout {
    @apply lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20;
  }

  &__main {
    @apply relative z-10 mx-auto max-w-2xl lg:col-span-6 lg:max-w-none lg:pt-6 xl:col-span-6;
  }
